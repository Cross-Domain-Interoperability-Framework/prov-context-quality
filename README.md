...
Galaxy workflow RO-Crates originate from [Zenodo record 13842780](https://zenodo.org/records/13842780). All `.cdifprov.json` files were generated using the [WRROCToCdifProv.py](https://github.com/Cross-Domain-Interoperability-Framework/packaging/tree/main/tools/WRROCToCdifProv.py) converter.
